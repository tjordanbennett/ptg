...
export function ContactForm() {
  ...
  return (
    <form ref={formRef} noValidate onSubmit={onSubmit} aria-describedby="form-status" style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div>
        <button type="submit" className="hov-cta-ember" style={{ fontFamily: "inherit", fontSize: 15.5, fontWeight: 700, padding: "16px 34px", borderRadius: 3, border: 0, cursor: "pointer" }}>
          Send message
        </button>
      </div>
    </form>
