...
export const home: HomePage = {
  ...
  customers: {
    ...
    names: [
      ...
      { name: "Lee College" },
      { name: "Dallas Area Rapid Transit", logo: "/logos/customers/dart-mono.svg" },
  ...
  services: {
    ...
    items: [
      { name: "Workday Advisory & Strategy", summary: "Readiness assessments, roadmaps, business cases and change decisions, before you commit to a configuration or a go-live date.", href: "/services/workday-advisory-strategy" },
      { name: "Workday Implementation", summary: "Full-suite HCM, Financials, Student and Payroll deployments, delivered by the same team that scoped them.", href: "/services/workday-implementation" },
      { name: "Workday AMS & Optimization", summary: "Ongoing support, release management and twice-yearly feature adoption, with named consultants who already know your tenant instead of a ticket queue.", href: "/services/workday-ams-optimization" },
      { name: "Workday Innovation", summary: "Extend, Prism, integrations and AI-enabled workflows for the problems standard functionality doesn't cover.", href: "/services/workday-innovation" },
      { name: "ServiceNow Implementation", summary: "ITSM, service portals and workflow automation for organizations standardizing service delivery alongside Workday.", href: "/services/servicenow-implementation" },
    ],
  },
